...
import { Box, Grid, Typography, List, ListItem, Select, MenuItem, Button, TextField, Paper } from '@mui/material';
      ...
      <Grid container spacing={2} padding={3} flex={1}>
        ...
        <Grid item xs={12} md={3}>
          <Box bgcolor="#5D786F" color="white" p={2} borderRadius={2}>
            ...
            <List>
              <ListItem>Quản lý bệnh nhân</ListItem>
              <ListItem>Hồ sơ điều trị (Treatment & Medical Records)</ListItem>
              <ListItem>Lịch hẹn của tôi</ListItem>
              <ListItem>Gửi lời nhắc (Reminders)</ListItem>
              <ListItem>Hồ sơ cá nhân bác sĩ</ListItem>
            </List>
          </Box>
        </Grid>
