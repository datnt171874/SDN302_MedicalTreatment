...
const DoctorPage = () => {
  ...
  const [medicalRecord, setMedicalRecord] = useState({
    userId: "",
    appointmentId: "",
    treatmentPlanId: "", // New field for selecting treatment plan
    diagnosis: "",
    prescription: {
      medicationName: "",
      dosage: "",
  ...
  const handleOpenMedicalRecord = (appointment) => {
    setMedicalRecord({
      ...
      treatmentPlanId: "", // Initialize empty
      diagnosis: "",
      prescription: {
        medicationName: "",
        dosage: "",
  ...
  const handleSaveMedicalRecord = async () => {
    try {
      ...
      const recordData = {
        ...
        treatmentPlanId: medicalRecord.treatmentPlanId || null, // Include treatmentPlanId
      ...
      setSuccess("Medical record created successfully"); // Set success message
        ...
        <Dialog open={openMedicalRecord} onClose={handleCloseMedicalRecord} fullWidth maxWidth="sm">
          ...
          <DialogContent>
            ...
            <TextField
              fullWidth
              label="Tên thuốc"
              value={medicalRecord.prescription.medicationName}
              onChange={(e) =>
                setMedicalRecord({
                  ...medicalRecord,
                  prescription: { ...medicalRecord.prescription, medicationName: e.target.value },
                })
              }
              sx={{ mt: 2 }}
            />
            <TextField
              ...
              onChange={(e) =>
                setMedicalRecord({
                  ...medicalRecord,
                  prescription: { ...medicalRecord.prescription, dosage: e.target.value },
                })
              }
              sx={{ mt: 2 }}
            />
            <TextField
              fullWidth
              label="Tần suất"
              value={medicalRecord.prescription.frequency}
              onChange={(e) =>
                setMedicalRecord({
                  ...medicalRecord,
                  prescription: { ...medicalRecord.prescription, frequency: e.target.value },
                })
              }
              sx={{ mt: 2 }}
            />
            <TextField
              ...
              onChange={(e) =>
                setMedicalRecord({
                  ...medicalRecord,
                  prescription: { ...medicalRecord.prescription, duration: e.target.value },
                })
              }
              sx={{ mt: 2 }}
            />
            <TextField
              ...
              onChange={(e) =>
                setMedicalRecord({
                  ...medicalRecord,
                  prescription: { ...medicalRecord.prescription, instructions: e.target.value },
                })
              }
              sx={{ mt: 2 }}
            />
