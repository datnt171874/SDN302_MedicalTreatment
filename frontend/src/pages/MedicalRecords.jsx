...
function MedicalRecords() {
  ...
  const recentDiagnoses = [
    ...
    { date: '01/02/2023', diagnosis: 'Acute pharyngitis', doctor: 'Dr. Robert Brown' },
  ];

  const medications = [
    { name: 'Paracetamol', dosage: '500mg', frequency: 'Twice a day', startDate: '10/03/2023' },
    { name: 'Amoxicillin', dosage: '250mg', frequency: 'Three times a day', startDate: '02/02/2023' },
  ];
        ...
        <Grid item xs={12} lg={8}>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            ...
            <Card sx={{ 
              ...
              <Box sx={{ 
                background: 'linear-gradient(135deg, #4A6D5A 0%, #5A7D6A 100%)', 
                p: 3,
                display: 'flex',
                alignItems: 'center'
              }}>
                    ...
                    <TableBody>
                      {recentDiagnoses.map((row, index) => (
                        ...
                        >
                          ...
                          <TableCell sx={{ py: 1.5, color: '#666', fontSize: '0.85rem' }}>
                            {row.doctor}
                          </TableCell>
                        </TableRow>
                      ))}
