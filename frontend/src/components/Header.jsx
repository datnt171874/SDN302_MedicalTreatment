...
const Header = () => {
  ...
  return (
    <AppBar position="sticky" elevation={0} sx={{ py: 2, borderBottom: '1px solid', borderColor: 'secondary.main', bgcolor: 'primary.main' }}>
        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' }, justifyContent: 'flex-end' }}>
            ...
            >
              ...
              <MenuItem component={Link} to="/testimonial" onClick={handleClose}>
                Phản hồi
              </MenuItem>
